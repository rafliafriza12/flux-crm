...
import { Button, Heading1, Icon } from "@/components/atoms";
...
const CreateCustomerTemplate: React.FC = () => {
      ...
      <div className="w-full bg-white dark:bg-black border border-greyscale-100-light dark:border-greyscale-100-dark rounded-2xl p-6 ipad-vertical:p-8">
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="relative">
                ...
                >
                  <option value="" disabled className="text-neutral-text">
                    Input customer type
                  </option>
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  className="w-full bg-greyscale-50-light dark:bg-greyscale-50-dark text-black dark:text-white placeholder:text-neutral-text rounded-xl pl-12 pr-4 py-3.5 border border-greyscale-100-light dark:border-greyscale-100-dark focus:outline-none focus:border-primary appearance-none cursor-pointer [&::-webkit-calendar-picker-indicator]:opacity-0 [&::-webkit-calendar-picker-indicator]:absolute [&::-webkit-calendar-picker-indicator]:right-0 [&::-webkit-calendar-picker-indicator]:w-full [&::-webkit-calendar-picker-indicator]:h-full [&::-webkit-calendar-picker-indicator]:cursor-pointer"
                />
                <div className="absolute right-4 top-1/2 -translate-y-1/2 pointer-events-none">
                  <Icon
                    name="arrow-down-s-line"
          ...
          <div className="flex items-center justify-end">
            ...
            >
              <Icon name="add-line" size="sm" className="text-black" />
              <span className="font-medium">
                {isSubmitting ? "Creating..." : "Add New Customer"}
              </span>
            </button>
          </div>
        </form>
